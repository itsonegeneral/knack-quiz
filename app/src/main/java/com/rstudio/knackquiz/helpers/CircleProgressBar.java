...
public class CircleProgressBar extends View {
    ...
    public void setColor(int color) {
        this.color = color;
        backgroundPaint.setColor(Color.parseColor("#76afcf"));
        foregroundPaint.setColor(Color.parseColor("#76afcf"));
        invalidate();
        requestLayout();
    }
    ...
    private void init(Context context, AttributeSet attrs) {
      ...
      try {
        ...
        backgroundPaint.setColor(getResources().getColor(R.color.colorPrimaryDark)); //background color
