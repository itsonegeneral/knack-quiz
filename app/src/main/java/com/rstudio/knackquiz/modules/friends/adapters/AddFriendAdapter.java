...
public class AddFriendAdapter extends RecyclerView.Adapter<AddFriendAdapter.ViewHolder> {
    ...
    public AddFriendAdapter(Context context, ArrayList<Player> players) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.btAddFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendFriendRequest(players.get(position).getPlayerID(),holder.btAddFriend);
            }
        });
    }
    ...
    private void sendFriendRequest(final String playerID, final Button button) {
